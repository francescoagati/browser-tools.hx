...
class Main {
  static function main() {
    ...
    assets.createGroup() << 'http://cdnjs.cloudflare.com/ajax/libs/crossfilter/1.3.11/crossfilter.min.js';
    assets.createGroup() << 'http://cdnjs.cloudflare.com/ajax/libs/dc/1.7.3/dc.min.js';
